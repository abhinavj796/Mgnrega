...
<BR>
   <H1>Mahatma Gandhi National Rural Employment Gurantee Act </H1>

<br>
<br>
<Form Method ="Post" Action = "ChangePass" OnSubmit="return check(this)">
<FONT COLOR = #3333ff>Old Password: &nbsp&nbsp&nbsp&nbsp&nbsp
<Input Type = "password" Value="" Name = "pas" required>
