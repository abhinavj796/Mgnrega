...
ps1.setString(1, nid);
ps1.setString(2, (String)session.getAttribute("nm"));
ps1.setString(3, add);
ps1.setString(4, request.getParameter("doj"));
ps1.setString(5, request.getParameter("nod"));
ps1.setString(6, Integer.toString(Wage));
ps1.setString(7, mno);
ps1.setString(8, lid);
ps1.executeUpdate();
}
...
out.println(" Your Reciept is:<BR><BR><Font Size = 3 Color = 'Red'>" );

out.println("<table id=\"mytable\">\n" +
"<tr><th>Labourid</th><th>Userid</th><th>Your Name</th><th>Your Address</th><th>DOJ</th><th>NOD</th><th>Wage</th><th>Your Mno.</th></tr>\n" +
...
out.println("<Br><Input Type='Submit' Value='More'></CENTER>");
